...
isAuthenticated = ({ email, password }) => hotelDB.usuarios.findIndex(user => user.email === email && user.password === password) !== - 1;
...
server.post('/auth/login', (req, res) => {
    ...
    res.status(200).json({ access_tohttp://localhost:3985/hotelesken })
});
